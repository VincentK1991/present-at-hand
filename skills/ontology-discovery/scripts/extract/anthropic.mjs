...
- Sentence-level / statement-level classes (those whose rdfs:comment
  describes them as one instance per sentence, bullet, finding, claim,
  event, observation, or the like) MUST be minted once per matching
  sentence, even though the referent is the sentence itself, not a
  noun phrase. For these, use the verbatim sentence as the "mention"
  and a short summary label as "canonical". Multiple such classes may
  co-apply to the same sentence.
